...
| block                  | can access                         | 
|------------------------|------------------------------------|
| return instances       | query instances                    |
| `compensations.logic`  | insight instances, ad instances    |
| `returns.logic`        | return instances, query instances  |
| `ads.logic`            | query instances, insight instances |

export const exampleCovalentResponse = {
  data: {
    address: "0x38779ede53ab96451772b79cb08a91677442a40b",
    updated_at: "2022-07-11T20:50:55.244733127Z",
    next_update_at: "2022-07-11T20:55:55.244733187Z",
    quote_currency: "USD",
    chain_id: 1,
    items: [
      {
      ...
      {
        block_signed_at: "2021-12-06T05:35:15Z",
        block_height: 13750483,
        tx_hash:
          "0x46cd443f8ef42a735b787674bcebf94c3e060506c06f66ddc3298ac70254baf9",
        tx_offset: 221,
        successful: true,
        from_address: "0x38779ede53ab96451772b79cb08a91677442a40b",
        from_address_label: null,
        ...
        gas_offered: 127842,
        gas_spent: 127526,
        gas_price: 86751330627,
        fees_paid: "11063050189538802",
        gas_quote: 46.93620045023285,
        gas_quote_rate: 4242.609375,
        log_events: [
          {
            block_signed_at: "2021-12-06T05:35:15Z",
            block_height: 13750483,
            ...
            raw_log_topics: [
              ...
              "0x24100c3f2d01049564baac19c31fb13e5440eb6cb8c7c1d0b140bd553c277656",
            ],
            sender_contract_decimals: 0,
            sender_name: null,
            sender_contract_ticker_symbol: null,
            ...
            sender_address_label: null,
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/1/0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e.png",
            raw_log_data:
              ...
              params: [
                {
                  ...
                  indexed: true,
                  decoded: true,
                  value: "JBAMPy0BBJVkuqwZwx+xPlRA62y4x8HQsUC9VTwndlY=",
                },
                {
                  name: "resolver",
                  type: "address",
          ...
          },
          {
            ...
            raw_log_topics: [
              ...
              "0xdf9785a249ae9c032e640b4616d9253f726439ca57ecb6892ae98605d9699901",
            ],
            sender_contract_decimals: 0,
            sender_name: null,
            sender_contract_ticker_symbol: null,
            ...
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/1/0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e.png",
            raw_log_data:
              "0x000000000000000000000000084b1c3c81545d370f3634392de611caabff8148",
            decoded: {
              name: "NewOwner",
              signature:
              ...
              params: [
                ...
                },
                {
                  ...
                  indexed: true,
                  decoded: true,
                  value: "35eFokmunAMuZAtGFtklP3JkOcpX7LaJKumGBdlpmQE=",
                },
                {
                  name: "owner",
                  type: "address",
      ...
      {
        block_signed_at: "2021-12-06T05:34:38Z",
        block_height: 13750477,
        tx_hash:
          "0x22db8eb94ef4a00bba6d95a4d2b751255eafe470d4c169b4258f15669464d3fc",
        tx_offset: 119,
        successful: true,
        from_address: "0x38779ede53ab96451772b79cb08a91677442a40b",
        from_address_label: null,
        ...
        to_address_label: null,
        value: "6581334465681620",
        value_quote: 27.922031304111457,
        gas_offered: 310376,
        gas_spent: 279544,
        gas_price: 97233263524,
        fees_paid: "27180975418553056",
        gas_quote: 115.31826113239775,
        gas_quote_rate: 4242.609375,
        log_events: [
          {
            block_signed_at: "2021-12-06T05:34:38Z",
            ...
            raw_log_topics: [
              ...
              "0x8bf988d18538e943c74fe8fb22c0c2ce1ea9a91e6d3d5bc78a6559f16b98f88d",
              "0x00000000000000000000000038779ede53ab96451772b79cb08a91677442a40b",
            ],
            sender_contract_decimals: 0,
            sender_name: null,
            ...
            sender_address_label: null,
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/1/0x283af0b28c62c092c9727f1ee09c02ca627eb7f5.png",
            raw_log_data:
              "",
            decoded: {
              name: "NameRegistered",
              signature:
              ...
              params: [
                ...
                },
                {
                  ...
                  indexed: true,
                  decoded: true,
                  value: "i/mI0YU46UPHT+j7IsDCzh6pqR5tPVvHimVZ8WuY+I0=",
                },
                {
                  name: "owner",
                  type: "address",
          ...
          },
          {
            ...
            raw_log_topics: [
              ...
              "0x4c61285cea4b519238aac84c9f5f9af53e945e43ad34781c0529365135024079",
            ],
            sender_contract_decimals: 0,
            sender_name: null,
            sender_contract_ticker_symbol: null,
            ...
            sender_address_label: null,
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/1/0x4976fb03c32e5b8cfe2b6ccb31c09ba78ebaba41.png",
            raw_log_data:
              "0x00000000000000000000000038779ede53ab96451772b79cb08a91677442a40b",
            decoded: {
              name: "AddrChanged",
              ...
              params: [
                {
                  ...
                  indexed: true,
                  decoded: true,
                  value: "TGEoXOpLUZI4qshMn1+a9T6UXkOtNHgcBSk2UTUCQHk=",
                },
                {
                  name: "a",
                  type: "address",
          ...
          },
          {
            ...
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/1/0x4976fb03c32e5b8cfe2b6ccb31c09ba78ebaba41.png",
            raw_log_data:
              "",
            decoded: {
              name: "AddressChanged",
              signature:
              ...
              params: [
                ...
                },
                {
                  ...
                  indexed: false,
                  decoded: true,
                  value: "OHee3lOrlkUXcrecsIqRZ3RCpAs=",
                },
              ],
            },
          },
          ...
          },
          {
            ...
            sender_logo_url:
              "https://logos.covalenthq.com/tokens/0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85.png",
            raw_log_data:
              "0x000000000000000000000000000000000000000000000000000000006b153ba6",
            decoded: {
              name: "NameRegistered",
              signature:
              ...
              params: [
                {
                  ...
                  decoded: true,
                  value:
                    "63312375158365809330854958554770076922362348103126704408797725657169256839309",
                },
                {
                  name: "owner",
                  type: "address",
      ...
      {
        block_signed_at: "2021-12-06T05:30:28Z",
        block_height: 13750466,
        tx_hash:
          "0xa3dfc72d096bd4901983d44834c69704d2e62e04f3c6354d16a73008e4c9cb8f",
        tx_offset: 278,
        successful: true,
        from_address: "0x38779ede53ab96451772b79cb08a91677442a40b",
        from_address_label: null,
        ...
        gas_offered: 46267,
        gas_spent: 46267,
        gas_price: 84698728358,
        fees_paid: "3918756064939586",
        gas_quote: 16.625751219450795,
        gas_quote_rate: 4242.609375,
        log_events: [],
      },
      {
        block_signed_at: "2021-11-21T21:46:30Z",
        block_height: 13660625,
        tx_hash:
          "0xb4b0442bdd8913d68b3f255519296e0603de925133a7d8f9000a0a44464713bb",
        tx_offset: 164,
        successful: true,
        from_address: "0xddfabcdc4d8ffc6d5beaf154f18b778f892a0740",
        from_address_label: "Coinbase 3",
        to_address: "0x38779ede53ab96451772b79cb08a91677442a40b",
        to_address_label: null,
        value: "63691350000000000",
        value_quote: 279.0360027544189,
        gas_offered: 21000,
        gas_spent: 21000,
        gas_price: 177525440858,
        fees_paid: "3728034258018000",
        gas_quote: 16.33276382882258,
        gas_quote_rate: 4381.06591796875,
        log_events: [],
      },
    ],
    pagination: {

...
export class DefaultAccountNFTs implements IAccountNFTs {
  ...
  protected alchemyRepo: IEVMNftRepository;
  ...
  public constructor(
    ...
    this.alchemyRepo = new AlchemyIndexer(
      this.configProvider,
      this.ajaxUtils,
      this.tokenPriceRepo,
      this.logUtils,
  ...
  public getAlchemyTokens(): ResultAsync<IEVMNftRepository, never> {
    return okAsync(this.alchemyRepo);
  }

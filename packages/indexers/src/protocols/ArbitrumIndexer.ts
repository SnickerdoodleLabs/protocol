  ...
  implements IEVMTransactionRepository, IEVMAccountBalanceRepository
{
  ...
  public getBalancesForAccount(
    ...
    console.log("Arbitrum get Balances");
    return ResultUtils.combine([
      this._getEtherscanApiKey(chainId),
      ...
      return this.ajaxUtils
        ...
        .andThen((response) => {
          ...
          console.log("Arbitrum response: ", response);
          return ResultUtils.combine(
            ...
            console.log("Arbitrum balances: ", balances);
            return okAsync(

export enum ECoreActions {
  ...
  GET_ACCOUNT_CACHED_NFTS = "GET_ACCOUNT_CACHED_NFTS",
  GET_ACCOUNT_PERSISTENCE_NFTS = "GET_ACCOUNT_PERSISTENCE_NFTS",
  GET_ACCOUNT_NFT_HISTORY = "GET_ACCOUNT_NFT_HISTORY",
  GET_ACCOUNT_CACHED_NFTS_WITH_HISTORY = "GET_ACCOUNT_CACHED_NFTS_WITH_HISTORY",
  GET_ACCOUNT_NFTS_WITH_HISTORY_USING_BENCHMARK = "GET_ACCOUNT_NFTS_WITH_HISTORY_USING_BENCHMARK",

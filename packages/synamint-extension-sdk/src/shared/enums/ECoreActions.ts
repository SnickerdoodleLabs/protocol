export enum ECoreActions {
  ...
  REJECT_INVITATION_BY_UUID = "REJECT_INVITATION_BY_UUID",
  ...
  GET_POSSIBLE_REWARDS = "GET_POSSIBLE_REWARDS",
  ...
  GET_TRANSACTIONS_VALUE_BY_CHAIN = "GET_TRANSACTIONS_VALUE_BY_CHAIN",
  ...
  SCRAPER_CLASSIFY_URL_PARAMS = "SCRAPER_CLASSIFY_URL_PARAMS",
  SCRAPER_SCRAPE_PARAMS = "SCRAPER_SCRAPE_PARAMS",

  SCRAPER_NAVIGATION_AMAZON_GET_ORDER_HISTORY_PAGE_PARAMS = "SCRAPER_NAVIGATION_AMAZON_GET_ORDER_HISTORY_PAGE_PARAMS",
  SCRAPER_NAVIGATION_AMAZON_GET_YEARS_PARAMS = "SCRAPER_NAVIGATION_AMAZON_GET_YEARS_PARAMS",
  SCRAPER_NAVIGATION_AMAZON_GET_ORDER_HISTORY_PAGE_BY_YEAR_PARAMS = "SCRAPER_NAVIGATION_AMAZON_GET_ORDER_HISTORY_PAGE_BY_YEAR_PARAMS",
  SCRAPER_NAVIGATION_AMAZON_GET_PAGE_COUNT_PARAMS = "SCRAPER_NAVIGATION_AMAZON_GET_PAGE_COUNT_PARAMS",

  PURCHASE_GET_PARAMS = "PURCHASE_GET_PARAMS",
  PURCHASE_GET_BY_MARKET_PLACE = "PURCHASE_GET_BY_MARKET_PLACE",
  PURCHASE_GET_BY_MARKET_PLACE_AND_DATE = "PURCHASE_GET_BY_MARKET_PLACE_AND_DATE",
}

export enum ECoreActions {
  ...
  SCRAPER_NAVIGATION_GET_ORDER_HISTORY_PAGE_PARAMS = "SCRAPER_NAVIGATION_GET_ORDER_HISTORY_PAGE_PARAMS",
  SCRAPER_NAVIGATION_GET_YEARS_PARAMS = "SCRAPER_NAVIGATION_GET_YEARS_PARAMS",
  SCRAPER_NAVIGATION_GET_ORDER_HISTORY_PAGE_BY_YEAR_PARAMS = "SCRAPER_NAVIGATION_GET_ORDER_HISTORY_PAGE_BY_YEAR_PARAMS",
  SCRAPER_NAVIGATION_GET_PAGE_COUNT_PARAMS = "SCRAPER_NAVIGATION_GET_PAGE_COUNT_PARAMS",

  PURCHASE_GET_PURCHASED_PRODUCTS_PARAMS = "PURCHASE_GET_PURCHASED_PRODUCTS_PARAMS",

import { useStyles } from "@extension-onboarding/components/RewardItems/PossibleLazyReward/PossibleLazyReward.style";
...
interface IPossibleLazyRewardProps {

import { useStyles } from "@extension-onboarding/components/RewardItems/PossibleWeb2Reward/PossibleWeb2Reward.style";
...
interface IPossibleWeb2RewardProps {

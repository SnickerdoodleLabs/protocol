...
const RewardProgramDetails: FC = () => {
  ...
  const {
    tag = "",
    possibleRewards: initialPossibleRewards,
    info,
  ...
  const {
    ...
    if (!isSubscribed) {
      ...
      const { queryBeingProcessed, queryProcessed } = possibleRewards.reduce<{
        ...
        { queryBeingProcessed: [], queryProcessed: [] },
      );

    ...
    if (media === "xs") {
      return (
        ...
        >
          <>
            <Box pt={3} />
            <img width="50%" src={ProfileSteps[currentStep].image} />
            <SDTypography align="center" variant="headlineLg" fontWeight="bold">
            ...
            <SDTypography align="center" variant="bodyLg">

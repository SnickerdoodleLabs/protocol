  ...
  public constructor() {
    ...
    this.config = new CoreConfig(
      ...
      4000, // polling interval for consent contracts on control chain
      {
        ...
        Arbitrum: "https://arb-mainnet.g.alchemy.com/v2/_G9cUGHUQqvD2ro5zDaTAFXeaTcNgQiF",
        Optimism: "https://opt-mainnet.g.alchemy.com/v2/f3mMgv03KKiX8h-pgOc9ZZyu7F9ECcHG",
      },
      10000,
      "(localhost|chrome://)",

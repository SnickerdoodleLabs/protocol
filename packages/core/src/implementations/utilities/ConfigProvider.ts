    ...
    IPersistenceConfigProvider
{
  ...
  public constructor() {
    ...
    this.config = new CoreConfig(
      controlChainId,
      [ChainId(EChain.EthereumMainnet), ChainId(EChain.Solana)], // supported chains (local hardhat only for the test harness, we can index other chains here though)
      chainConfig,
      controlChainInformation,

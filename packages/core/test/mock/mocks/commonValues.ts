...
export const testCoreConfig = new CoreConfig(
  ...
  100000, // backupChunkSizeTarget
  {
    ...
    etherscanApiKeys: new Map<EChain, string | null>([
      [EChain.EthereumMainnet, "Etherscan Ethereum Key"],
      [EChain.Polygon, "Etherscan Polygon Key"],
      [EChain.Avalanche, "Etherscan Avalanche Key"],
      [EChain.Moonbeam, "Etherscan Moonbeam Key"],
      [EChain.Optimism, "Etherscan Optimism Key"],
      [EChain.Arbitrum, "Etherscan Arbitrum Key"],
      [EChain.Gnosis, "Etherscan Gnosis Key"],
      [EChain.Fuji, "Etherscan Fuji Key"],
    ]),

...
task("checkdomain", "Check if a domain is associated with a contract.")
  .addParam("contract", "address of the erc7529-compatible contract")
  .addParam("domain", "domain name to check for association")
  .setAction(async () => {

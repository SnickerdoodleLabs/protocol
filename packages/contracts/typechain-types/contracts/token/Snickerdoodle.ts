...
export interface SnickerdoodleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface Snickerdoodle extends BaseContract {
  connect(runner?: ContractRunner | null): Snickerdoodle;
  waitForDeployment(): Promise<this>;

  interface: SnickerdoodleInterface;

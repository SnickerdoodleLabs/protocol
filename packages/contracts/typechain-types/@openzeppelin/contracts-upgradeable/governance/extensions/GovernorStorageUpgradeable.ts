...
export interface GovernorStorageUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorStorageUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorStorageUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: GovernorStorageUpgradeableInterface;

const envVars = {
  ...
  __PORTFOLIO_POLLING_INTERVAL__: "3000", // ANDREW CHANGED HERE
  __TRANSACTION_POLLING_INTERVAL__: "4000", // ANDREW CHANGED HERE
  __BACKUP_POLLING_INTERVAL__: "1000", // ANDREW CHANGED HERE

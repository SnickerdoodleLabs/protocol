...
const GoogleCard: FC = () => {
  ...
  useEffect(() => {
    Browser.storage.local.get("googleData").then((data) => {
      console.log("googleData", data);
      setObj(data.googleData);
    });
  ...
  return (
    <Grid className={classes.googleCardContainer}>
      ...
      {obj ? (
        <Grid>
          <Grid className={classes.cardPersonalContainer}>
            ...
            <Grid className={classes.cardDataContainer}>
              ...
              <img
                ...
                src={
                  obj?.photos
                    ? obj?.photos[0].url
                    : Browser.runtime.getURL("assets/img/personIcon.png")
                }
              />
            </Grid>
            ...
            <GoogleCardData
              title="GENDER"
              information={
                obj?.genders ? obj?.genders[0]?.formattedValue : "N/A"
              }
            />
            <GoogleCardData
              title="EMAIL"
        ...
        <Grid style={{ textAlign: "center", paddingTop: "200px" }}>
          <CircularProgress />
        </Grid>
      )}
    </Grid>

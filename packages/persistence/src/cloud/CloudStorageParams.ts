...
export class CloudStorageParams implements ICloudStorageParams {
    public constructor(
        ...
        protected dataWalletAddres: string, // gcp credentials // pass in the refreshtoken from dropbox // pass in the chosen folder location into params // form factor needs a file picker correlated with dropbox (only once, first time during set up.  Then cache. )
    ) { }

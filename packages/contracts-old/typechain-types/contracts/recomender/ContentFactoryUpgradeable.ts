...
export interface ContentFactoryUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "computeFee"
      | "getGovernanceToken"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Initialized" | "RankingUpdate"
  ): EventFragment;
...
export interface ContentFactoryUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ContentFactoryUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: ContentFactoryUpgradeableInterface;

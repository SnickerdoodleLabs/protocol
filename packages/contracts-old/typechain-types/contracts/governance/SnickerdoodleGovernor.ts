...
export interface SnickerdoodleGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface SnickerdoodleGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): SnickerdoodleGovernor;
  waitForDeployment(): Promise<this>;

  interface: SnickerdoodleGovernorInterface;
